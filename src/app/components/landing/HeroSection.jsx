    ...
    <section className="relative min-h-screen flex items-center justify-center pt-16 px-6 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto text-center">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-slate-900 tracking-tight leading-tight mb-6"
        >
          Ecosistemi Digitali{" "}
        ...
        >
          Non scrivo solo codice: progetto soluzioni che fanno risparmiare tempo
          e aumentano il valore del tuo business.
        </motion.p>
        ...
        >
          ...
          {/* <a
            ...
            className="px-8 py-3.5 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition-colors duration-200 text-sm inline-flex items-center gap-2"
          >
